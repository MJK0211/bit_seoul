...
# print(x_bit_train.shape) #(498, 3, 5)
# print(x_bit_test.shape) #(125, 3, 5)
# print(x_bit_predict.shape) #(3, 5)

# print(x_kosdaq_train.shape) #(498, 3, 4)
# print(x_kosdaq_test.shape) #(125, 3, 4)
# print(x_kosdaq_predict.shape) #(3, 4)

# print(x_gold_train.shape) #(498, 3, 3)
# print(x_gold_test.shape) #(125, 3, 3)
# print(x_gold_predict.shape) #(3, 3)

x_samsung_train = x_samsung_train.reshape(498,18)
x_samsung_test = x_samsung_test.reshape(125,18)
x_samsung_predict = x_samsung_predict.reshape(1,18)

x_bit_train = x_bit_train.reshape(498,15)
x_bit_test = x_bit_test.reshape(125,15)
x_bit_predict = x_bit_predict.reshape(1,15)

x_kosdaq_train = x_kosdaq_train.reshape(498,12)
x_kosdaq_test = x_kosdaq_test.reshape(125,12)
x_kosdaq_predict = x_kosdaq_predict.reshape(1,12)

x_gold_train = x_gold_train.reshape(498,9)
...
model.fit([x_samsung_train_minmax, x_bit_train_minmax, x_kosdaq_train_minmax, x_gold_train_minmax], y_samsung_train, epochs=100000, batch_size=32, validation_split=0.25, verbose=1, callbacks=[early_stopping])
