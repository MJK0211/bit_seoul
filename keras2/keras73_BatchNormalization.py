...
model.add(Conv2D(20, (2,2), kernel_initializer='he_normal')) #(27,27,20)
model.add(BatchNormalization())
model.add(Activation('relu'))

model.add(Conv2D(30, (3,3), kernel_regularizer=l1(0.01))) #(25,25,30)
...
# 수정후 결과값
# loss :  0.12538385391235352
# acc :  0.9854854941368103
# y_real :  [7 2 1 0 4 1 4 9 5 9]
# y_pred :  [7 2 1 0 4 1 4 9 5 9]