...
#2. 모델 구성
vgg19 = VGG19(include_top=False, input_shape=(x_train.shape[1], x_train.shape[2], x_train.shape[3]))
...
# loss :  1.2114982604980469
# acc :  0.5890890955924988
# y_real :  [3 8 8 0 6 6 1 6 3 1]
# y_pred :  [5 8 9 0 6 4 1 2 3 5]